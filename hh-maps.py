...
# -*- coding: utf-8 -*-
"""
Created on Sun Aug 25 12:26:37 2024
...
# Request focus zone input from user
focus_zone = int(input("Please enter the focus zone ID: "))

# Create to_focus DataFrame
to_focus = trip_data[trip_data['ToZone'] == focus_zone].copy()

# Create from_focus DataFrame
from_focus = trip_data[trip_data['fromZone'] == focus_zone].copy()

# Add these paths at the beginning of your script
to_path = f"/Users/noamgal/Downloads/To-From/ToFocus_{focus_zone}"
from_path = f"/Users/noamgal/Downloads/To-From/FromFocus_{focus_zone}"
...
for hour in time_dict.keys():
    ...
    create_interactive_map(zones, to_focus, focus_zone, direction='to', hour=hour)
    create_interactive_map(zones, from_focus, focus_zone, direction='from', hour=hour)
