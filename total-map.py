...
# -*- coding: utf-8 -*-
"""
Created on Sun Aug 25 12:32:54 2024
...
to_focus = travel_hh[travel_hh['ToZone'] == focus_zone].copy()

# Create from_focus DataFrame
from_focus = travel_hh[travel_hh['fromZone'] == focus_zone].copy()
...
def create_interactive_map(zones, trip_data, focus_zone_id, direction='to'):
    ...
    # Save the map
    m.save(f"/Users/noamgal/Downloads/interactive_trip_map_{direction}_{focus_zone_id}.html")
...
create_interactive_map(zones, to_focus_totals, focus_zone, direction='to')

# Create the interactive map for trips from the focus zone
create_interactive_map(zones, from_focus_totals, focus_zone, direction='from')